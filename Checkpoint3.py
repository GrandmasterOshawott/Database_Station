...
# Example: 1-14 round down to 0, 16-29 round down to 15
def roundTime(time):
...
def main():
    ...
    with conn:
        ...
        # Uncomment one at a time for clarity

        # Testing findRoute features
        Queries(conn)

        # findRoute with user input
        #Inputs(conn)
